      ...
      <P.PortfolioGrid>
        <div>
          ...
          <div>
            <h3>Summari apps</h3>
            <p>
              I am currently working at Summari where I have the opportunity to
              collaborate in the creation and maintainance of its mobile, chrome
              and web apps. You can see my work in action downloading the app.
              It's fun getting summaries from the content you usually read. Give
              it a try!
            </p>
